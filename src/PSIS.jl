#
# Implementation taken from: https://github.com/alvaro1101/PSIS.jl
# (minor changes to get it to run with Julia-1.5.0)
#
...
function psisloo(log_lik::AbstractArray,
...
"""
function psislw(lw::AbstractArray,
                wcpp::Int64=20, wtrunc::Float64=3/4)
...
"""
function gpdfitnew(x::AbstractArray{T}) where T<:Real
...
"""
function logsumexp(x::AbstractArray{T}, d::Int64=1) where T<:Real
    u = maximum(x)
